...
function launch_localnet() {
  ...
  base_args=(--log_folder "${log_folder}" --min_peers "${MIN}" --bootnodes "/ip4/172.31.15.9/tcp/19876/p2p/Qmc1V6W7BwX8Ugb42Ti8RnXF1rY5PF7nnZ6bKBryCgi6cv" "--network_type=$NETWORK" --blspass file:"${ROOT}/.hmy/blspass.txt" "--dns=false" "--verbosity=${verbosity}")
  sleep 2
